...
function Main() {
  return (
    <main className="relative z-10">
      <Container className="relative grid lg:grid-cols-mainSection gap-2 md:pt-10 pb-16">
        <img src={basketball} alt="Basketball image" className="absolute -z-10 top-32 -left-5 opacity-10 w-80 max-md:hiden" />
        <div className="relative max-lg:h-[calc(100vh-72px)] max-lg:grid max-lg:content-center max-lg:gap-8">
          <MainTitle />
          <img src={heroPlayer} alt="Basketball Player" className="absolute md:top-0 right-0 max-lg:hidden" />
          <div className="lg:absolute -bottom-10 right-0 lg:w-80 lg:ml-auto lg:mr-20 max-lg:text-center">
